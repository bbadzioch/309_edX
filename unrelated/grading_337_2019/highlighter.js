...
<div id="submenu" class="btn-group" style="font-weight:bold;margin-left:0" > \
    <button type="button" class="btn btn-group btn-default mark" style="font-weight:bold;margin-left:0;width:30px"  href="#" id="b2"><i class="fa fa-paint-brush"></i>  </button>\
    <button type="button" class="btn btn-group btn-default girk" style="font-weight:bold;margin-left:0;width:30px"  href="#" id="b3"><i class="fa fa-comment"></i>  </button>\
    <button type="button" class="btn btn-group btn-default burk" style="font-weight:bold;padding-left:0px;width:30px"  href="#" id="b1"> <i class="fa fa-bars"></i>  </button>\
